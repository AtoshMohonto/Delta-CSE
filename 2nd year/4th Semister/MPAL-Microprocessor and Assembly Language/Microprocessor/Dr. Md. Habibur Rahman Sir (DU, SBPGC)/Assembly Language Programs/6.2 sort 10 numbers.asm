...
.code segment					; code - name of user defined segment
assume ds: @data, cs: @code		; initialize ds and cs to segments
start:
	mov ax, @data				; initialize ds to  the data segment
	mov ds, ax				
rstart: 	mov cx, 10				; load 10 in count register - ekhane change kore number select korte hobe *
...
lrgnum:						; function to compare two numbers
      	...
      	mov bl, [di+1]
      	cmp al, bl
      	jge skip 				; descending / ascending - jge/jle
      	mov [di], bl
      	mov [di+1], al
