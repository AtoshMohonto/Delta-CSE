; 7
; a program to display any 10 decimal numbers and their corresponding ASCII characters
...
.data					; data - name of user defined segment
	...
	tab 	equ	09h			; ASCII code for tab
    	msg1 db cr, lf,'Ten different decimal numbers with ASCII to display......$'
	msg2 db cr, lf,'From which number You want to start? $'
	msg3 db cr, lf,'decimal',tab,'ASCII', '$'
...
start:
	...
	mov cx, 10				; initialize count register - koto tuku count korte hobe
	display msg3
...
next_deci:					; loop for printing ten numbers
	...
	display tb    
	display deci				; display ASCII value
	inc deci
	loop next_deci 
